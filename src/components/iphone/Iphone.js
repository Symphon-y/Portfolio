...
const Iphone = ({
  ...
  // Lingo Lingo Logo texture for screen
  const lingoScreen = useLoader(TextureLoader, 'lingolingoiphone.png');
  ...
  // Opens Modal if model is active object
  useEffect(() => {
      ...
      <group
        ...
        <group
          ...
          <mesh
            ...
            <meshStandardMaterial map={lingoScreen} transparent opacity={1} />
          </mesh>
          <mesh
        ...
        <Billboard follow={true} lockX={true} lockY={true} lockZ={true}>
          <Html
            transform
            distanceFactor={1}
            position={modal.open ? [0.08, 1.7, 0] : [0.2, 1.7, 0]}
            scale={(1.25, 1.25)}
            // rotation-x={-0.256}
          >
            <img alt='logo' src='/Rectangle.png' />
          </Html>
        </Billboard>
      </group>
    </>
